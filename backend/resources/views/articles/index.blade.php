...
<div class="flex flex-col items-center mb-8">
    <div class="flex justify-between items-center w-full">
        <h1 class="text-2xl font-semibold text-gray-700">Articles</h1>
        <div>
            @guest
...
@else
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        @foreach($articles as $article)
            <div class="bg-white shadow-md rounded-lg overflow-hidden {{ isset($article->is_expired) && $article->is_expired ? 'opacity-75' : '' }}">
                <div class="p-6">
